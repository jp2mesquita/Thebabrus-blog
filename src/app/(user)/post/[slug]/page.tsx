...
import { Post as PostTypeInterface } from '../../../../../typing'
...
export async function generateStaticParams() {
  ...
  const slugs: PostTypeInterface[] = await client.fetch(query)
...
`
  ...
  return (
    <article className="px-10 pb-28">
      <section className="space-y-2 border mb-10 border-[#f7ab0a] text-white">
